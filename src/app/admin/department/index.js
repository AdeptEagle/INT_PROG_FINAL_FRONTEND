...
router.get('/:id', authorize(), getByld);
...
try {
const departments = await db.Department.findAll({ include: [{ model:
db.Employee, attributes: ['id'] }]
});
...
res.json({...department.toJSON(), employeeCount:
